...
\newcolumntype{A}{>{\columncolor{white}}m{5cm}}
\newcolumntype{B}{>{\columncolor{LimeGreen!50!white}}m{1cm}}
\newcolumntype{C}{>{\columncolor{LimeGreen!50!white}}m{7cm}}
\newcolumntype{D}{>{\columncolor{LimeGreen!50!white}}m{6cm}}
\newcolumntype{E}{>{\columncolor{Yellow!50!white}}m{0.5cm}}
\newcolumntype{F}{>{\columncolor{Red!50!white}}m{6cm}}
\newcolumntype{G}{>{\columncolor{Red!50!white}}m{3cm}}
...
\tikzstyle{block} 		= [draw, fill={rgb:red,0;green,0.447;blue,0.7410;white,3}, rectangle, minimum height=1cm, minimum width=1.5cm, node distance=1.5cm, rounded corners]
\tikzstyle{sum} 		= [draw, fill={rgb:red,0;green,0.447;blue,0.7410;white,3}, circle, node distance=1.5cm]
\tikzstyle{input}		= [coordinate, node distance=1.5cm]
\tikzstyle{output}    	= [coordinate, node distance=1.5cm]
...
bottom=2.5cm, 
inner=1.8cm, 
outer=1.8cm % specifies the margins
]{geometry}
...
\setcounter{secnumdepth}{3} % determines up to what level the sectioning titles are numbered
\setcounter{tocdepth}{3} % determines to which level the sectioning commands are printed in the ToC
