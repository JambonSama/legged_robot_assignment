...
The objective of the mini-project is to go through the control design pipeline of a three-link 2D biped robot, in order to design and compare different controllers, both quantitatively (metrics of success) as well as qualitatively (gaits achieved).
