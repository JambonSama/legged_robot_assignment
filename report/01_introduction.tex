...
The second step is the controller design step, in which gaits are achieved through controllers strategies.
Finally, the third step is the control design step, which entails solving the equations of motion for the model as well as collision handling.
It is the simulation step.
