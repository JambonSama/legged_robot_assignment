...
\begin{enumerate}
	...
	This method is stable for complex roots of the characteristic equation within the circle defined by $s>-\dfrac{2}{dt}$. For real roots, the solution is always stable.
...
\begin{enumerate}
	...
	The LTE of RK4 is $O(dt^4)$, and thus GTE is $O(dt^3)$.
